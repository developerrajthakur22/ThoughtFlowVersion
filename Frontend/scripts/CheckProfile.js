...
let fetchUserAPI = `http://localhost:9990/UserProfile/${checkProfidleUserId}`;
...
//fetch following
fetch(`http://localhost:9990/UserFollowing/${checkProfidleUserId}`,{
    headers: {
        "Authorization": `Bearer ${jwtToken}`
    }
})
...
//fetch follower
fetch(`http://localhost:9990/UserFollower/${checkProfidleUserId}`,{
    headers: {
        "Authorization": `Bearer ${jwtToken}`
    }
})
