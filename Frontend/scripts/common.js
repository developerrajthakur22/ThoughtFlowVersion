...
if (jwtTokenCommon == null || userAccessID == null) {
    ...
    Swal.fire('Session timeout, Please login again!')
    window.location.href = "Login.html";
}

// profile pic code
let fetchUser = `http://localhost:9990/UserProfile/${userAccessID}`;
...
fetch(`http://localhost:9990/getNotication/${userAccessID}`, {
    method: "GET",
    headers: {
        "Authorization": `Bearer ${jwtTokenCommon}`
    }
