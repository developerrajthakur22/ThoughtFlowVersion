...
let fetchUserAPI = "http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/UserProfile/6";
...
function sendAddUserRequest(userObj) {
    fetch("http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/addUser", {
        method: "POST",
        headers: {
