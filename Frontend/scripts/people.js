...
function fetchUsersAndCheckFollowing() {
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/allUser`,{
        headers: {
...
function fetchUserFollowingStatus(userId) {
    return fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/UserFollowing/${userId}`,{
        headers: {
            "Authorization": `Bearer ${jwtToken}`
        }
    })
...
function followUser(userId, followUserId) {
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/addToFollowing/${userId}/${followUserId}`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${jwtToken}`
        }
...
function unfollowUser(userId, unfollowUserId) {
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/removeFollowing/${userId}/${unfollowUserId}`, {
        method: "DELETE",
        headers: {
            "Authorization": `Bearer ${jwtToken}`
        }
...
function searchUsers(keyword){
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/SearchUser/${keyword}`,{
        headers: {
            "Authorization": `Bearer ${jwtToken}`
        }
    })
...
function postFollowNotification(recipent_id, sender_id){
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/createFollowNoti/${recipent_id}/${sender_id}`, {
        method: "POST",
        headers:{
            "Authorization": `Bearer ${jwtToken}`
        }
