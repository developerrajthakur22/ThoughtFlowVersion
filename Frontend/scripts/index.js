...
const feedApi = `http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/Feed/${userID}`;

//code to search 
function searchPost(keyword) {
    fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/SearchPost/${keyword}`,{
        method: "GET",
        headers: {
...
function allPosts(){
    fetch("http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/allPosts",{
        headers: {
            "Authorization": `Bearer ${jwtToken}`
        }
    })
...
function displayFeed(data) {
    ...
    data.forEach((data, index) => {
        ...
        if (isLiked) {
            ...
            likeButton.innerHTML = `<i class="fa-regular fa-heart fa-beat" ></i>  (${likeCount})`;
      ...
      //  likeButton.style.color = "#3498db";
        ...
        likeButton.addEventListener("click", () => {
            ...
            if (!isLiked) {
                fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/LikePost/${data.post_id}/${userID}`, {
                    method: 'POST',
                    headers: {
                        "Authorization": `Bearer ${jwtToken}`
                    }
                ...
                fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/UnlikePost/${data.post_id}/${userID}`, {
                    method: 'DELETE',
                    headers: {
                        "Authorization": `Bearer ${jwtToken}`
                    }
        ...
        function fetchComments(post_id) {
            ...
            fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/PostComments/${post_id}`,{
                headers: {
                    "Authorization": `Bearer ${jwtToken}`
                }
            })
        ...
        function deleteAComment(post_id, Comment) {
            fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/deleteAComment/${post_id}`, {
                method: "DELETE",
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${jwtToken}`
        ...
        commentBtn.addEventListener("click", () => {
            ...
            if (comm == "") {
                ...
                fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/CommentPost/${data.post_id}/${userID}/${commmentInp.value}`, {
                    method: 'POST',
                    headers: {
                        "Authorization": `Bearer ${jwtToken}`
                    }
        ...
        deleteButton.addEventListener("click", () => {
            fetch(`http://thoughflowversion1withaws-env.eba-8prbfeav.ap-south-1.elasticbeanstalk.com/removePost/${data.post_id}/${userID}`, {
                method: "DELETE",
                headers: {
                    "Authorization": `Bearer ${jwtToken}`
                }
